        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Bejelentkezés</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="#">Üdvözlünk! Jelentkezz be, hogy hozzáférj személyes fiókodhoz, tananyagaidhoz és egyéb exkluzív tartalmainkhoz. Kezdjük el a tanulást együtt!</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <form method="POST" action="{{ route('login.post') }}">
                        @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" id="jelszo" name="jelszo" placeholder="Adja meg a jelszavát" required>
                            </div>
                            <button type="submit" class="btn btn-primary w-100">Bejelentkezés</button>
                        </form>
                    </div>
                    <div class="card-footer text-center">
                        <small>Nincs még fiókja? <a href="regisztracio">Regisztráljon itt!</a></small>
                    </div>
                </div>
            </div>
        </div>
